  ...
  return (
    <div className='min-h-screen bg-[#f3f3f3] flex flex-col'>
          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
            {
              [
                ...
                <motion.div key={index}
                  ...
                  className={`
        relative bg-white rounded-3xl border-2 border-[#1a1e20]
        hover:border-[#1a1e20] p-10 w-80 max-w-[90%] shadow-md hover:shadow-2xl 
      ...
      `}>
                  ...
                  <div className='absolute -top-8 left-1/2 -translate-x-1/2 bg-white border-2 border-[#1a1e20] text-[#1a1e20] w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg'>
                    {item.icon}</div>
                  <div className='pt-10 text-center'>
                    <div className='text-xs text-[#1a1e20] font-semibold mb-2 tracking-wider'>{item.step}</div>
                  ...
                  <motion.div key={index}
                    ...
                    <div className='flex flex-col md:flex-row items-center gap-8'>
                      ...
                      <div className='w-full md:w-1/2'>
                        <div className='bg-green-50 text-[#1a1e20] w-12 h-12 rounded-xl flex items-center justify-center mb-6'>
                          {item.icon}
                        </div>
