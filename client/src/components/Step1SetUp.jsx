        ...
        <motion.div
            ...
            <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
                ...
                <motion.div
                    ...
                    className='relative bg-linear-to-br from-gray-900 via-gray-800 to-black p-12 flex flex-col justify-center'>
                    ...
                    <div className='space-y-5'>

                        {
                            [
                                ...
                                {
                                    icon: <FaMicrophoneAlt className="text-black text-xl" />,
                    ...
                    <div className='space-y-6'>
                        ...
                        {!analysisDone && (
                            <motion.div
                                ...
                                <FaFileUpload className='text-4xl mx-auto text-black mb-3' />
                        ...
                        onClick={handleStart}
                            ...
                            whileHover={{ scale: 1.03 }}
                            whileTap={{ scale: 0.95 }}
                            className='w-full disabled:bg-gray-600 bg-linear-to-br from-gray-900 via-gray-800 to-black text-white py-3 rounded-full text-lg font-semibold transition duration-300 shadow-md'>
