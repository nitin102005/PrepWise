    ...
    <div className='min-h-screen bg-linear-to-br from-emerald-50 via-white to-teal-100 flex items-center justify-center p-4 sm:p-6'>
      <div className='w-full max-w-350 min-h-[80vh] bg-white rounded-3xl shadow-2xl border border-gray-200 flex flex-col lg:flex-row overflow-hidden'>
        ...
        <div className='flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative'>
          <h2 className='text-xl sm:text-2xl font-bold text-black merald-600 mb-6'>
            AI Smart Interview
          </h2>
          ...
          <textarea
            ...
            value={answer}
            className="flex-1 bg-gray-100 p-4 sm:p-6 rounded-2xl resize-none outline-none border border-gray-200 focus:ring-2 focus:ring-gray-500 transition text-gray-800" />
         ...
         {!feedback ? ( <div className='flex items-center gap-4 mt-6'>
            ...
            disabled={isSubmitting}
              whileTap={{ scale: 0.95 }}
              className='flex-1 bg-linear-to-br from-gray-900 via-gray-800 to-black text-white py-3 sm:py-4 rounded-2xl shadow-lg hover:opacity-90 transition font-semibold disabled:bg-gray-500'>
